...
class BankDisbursementPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final idbiOther = voucher.rows.where((r) => !r.ifscCode.startsWith('IDIB')).fold(0.0, (a, r) => a + r.amount);
    final idbiIdbi  = voucher.rows.where((r) =>  r.ifscCode.startsWith('IDIB')).fold(0.0, (a, r) => a + r.amount);
    ...
    return Container(
      ...
      child: DefaultTextStyle(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Center(
            child: Text('AARTI ENTERPRISES : TRAVEL EXPENSES',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12, decoration: TextDecoration.underline)),
          ),
  ...
  Widget _buildTable() {
    const headers = ['Amount','Debit A/c','IFSC','Credit A/c','Code','Beneficiary','Place','Bank','Debit Name'];
    return Table(
      ...
      children: [
        TableRow(
          ...
          children: headers.map((h) => Padding(
            ...
            child: Text(h, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 9)),
          )).toList(),
        ),
    ...
    child: Column(children: [
      ...
      Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          const Text('Total', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 9)),
          Text(voucher.baseTotal.toStringAsFixed(2), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 9)),
        ]),
      ),
    ]),
  );
  ...
  static Widget _summaryRow(String n, String label, String value) => Container(
    ...
    child: Row(children: [
      ...
      Text(value, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 9)),
    ]),
  );
}
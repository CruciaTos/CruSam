...
class _SalaryAttachmentAScreenState extends State<SalaryAttachmentAScreen> {
  ...
  void _showPreview() {
    showDialog(
      ...
      builder: (_) => _AttachmentAPreviewDialog(config: _config),
    );
  }
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Manpower Deployment Statement',
                        style: AppTextStyles.small),
                    const SizedBox(height: 24),
                    ElevatedButton.icon(
                      onPressed: _showPreview,
                      icon: const Icon(Icons.description_outlined, size: 16),
                      label: const Text('Preview Attachment A'),
                    ),
                  ],
                ),
              ),
...
class _AttachmentAPreviewDialog extends StatelessWidget {
  ...
  const _AttachmentAPreviewDialog({required this.config});
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text('Attachment A – Preview',
                ...
                child: SingleChildScrollView(
                  ...
                  child: Center(
                    child: ConstrainedBox(
                      ...
                      child: AttachmentAPreview(config: config),
                    ),
                  ),
                ),
              ),
